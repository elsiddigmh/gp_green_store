...
class SettingsController extends Controller {
    ...
    public function get_settings() {
        ...
        if (file_exists(resource_path() . "/language/website/$language.php")) {
